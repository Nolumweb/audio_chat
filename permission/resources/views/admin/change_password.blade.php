            ...
            <div class="card rounded">
              <div class="card-body">
                <div class="d-flex align-items-center justify-content-between mb-2">
                  ...
                  <div>
  <img class="wd-100 rounded-circle" src="{{ (!empty($Data->photo)) ? url('upload/admin_images/'.$Data->photo) : url('upload/no_image.jpg') }}" alt="profile">
          ...
          <div class="col-md-8 col-xl-8 middle-wrapper">
			...
			<form method="POST" action="{{ route('admin.update_password') }}" class="forms-sample" enctype="multipart/form-data">
				@csrf
